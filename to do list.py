...
if __name__ == "__main__":   
    ...
    guiWindow.configure(bg = "#E50000")  
    
#sql connection
    the_connection = sql.connect('LOT.db')
    the_cursor = the_connection.cursor()  
    the_cursor.execute('create table if not exists tasks (title text)')   
    tasks = []

    header_frame = tk.Frame(guiWindow, bg = "#C79FEF")  
    functions_frame = tk.Frame(guiWindow, bg = "#C79FEF")  
    listbox_frame = tk.Frame(guiWindow, bg = "#C79FEF")  
